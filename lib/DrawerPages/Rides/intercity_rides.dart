...
class InterCityRidePage extends StatefulWidget {
  String type;

  InterCityRidePage(this.type);

  @override
  State<InterCityRidePage> createState() => _InterCityRidePageState();
}

class _InterCityRidePageState extends State<InterCityRidePage> {
  ...
  getRides(type) async {
    try {
      ...
      Map response = await apiBase.postAPICall(
          Uri.parse(baseUrl1 + "Payment/get_shareing_ride"), params);
      ...
      if (response['status']) {
        ...
        for (int i = 0; i < rideList.length; i++) {
          setState(() {
            if (rideList[i].shareUserData != null) {
              int index = rideList[i]
                  .shareUserData!
                  .indexWhere((element) => element.userId == curUserId);
              if (index != -1) {
                rideList[i].selectedUser = index;
              }
            }
          });
        }
                  ...
                  ? rideList.length > 0
                      ? ListView.builder(
                          ...
                          itemBuilder: (context, index) => rideList[index]
                                      ...
                                      "Cancelled" &&
                                  rideList[index].show! &&
                                  rideList[index].selectedUser != null
                              ? Container(
                                  decoration: boxDecoration(
                                      bgColor: Colors.white,
                                      showShadow: true,
                                        ...
                                        child: Container(
                                          ...
                                          child: Column(
                                            children: [
                                                  ...
                                                  children: [
                                                                              ...
                                                                              builder: (context) => AlertDialog(
                                                                                    ...
                                                                                    actions: [
                                                                                      ...
                                                                                      TextButton(
                                                                                          onPressed: () {
                                                                                            Navigator.pop(context);
                                                                                            launch("tel://${rideList[index].driverContact}");
                                                                                          },
                                                                                          child: Text("Confirm")),
                                                                                    ],
                                                                                  ));
                                                    ...
                                                    Expanded(
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          Text(
                                                            '\u{20B9}${rideList[index].shareUserData![rideList[index].selectedUser!].totalAmount}',
                                                            style: theme
                                                                .textTheme
                                                                .bodyMedium!
                                                                .copyWith(
                                              ...
                                              Text(
                                                rideList[index].acceptReject ==
                                                        "6"
                                                    ? "Trip End OTP : ${rideList[index].bookingOtp}"
                                                    : "Start OTP : ${rideList[index].bookingOtp}",
                                              ),
                                              ListTile(
                                                ...
                                                title: Text(
                                                  '${rideList[index].shareUserData![rideList[index].selectedUser!].pickupAddress}',
                                                  style: TextStyle(
                                                      fontWeight:
                                                          FontWeight.w500),
                                                ),
                                              ...
                                              ListTile(
                                                ...
                                                title: Text(
                                                  '${rideList[index].shareUserData![rideList[index].selectedUser!].dropAddress}',
                                                  style: TextStyle(
                                                      fontWeight:
                                                          FontWeight.w500),
                                                ),
                                                            ...
                                                            animatedTexts: [
                                                              ColorizeAnimatedText(
                                                                rideList[index]
                                                                            .shareingType ==
                                                                        "1"
                                                                    ? "${getTranslated(context, "RIDE_TYPE")} - Sharing"
                                                                    : "${getTranslated(context, "RIDE_TYPE")} - Personal",
                                                                textStyle:
                                                                    colorizeTextStyle,
                                                                colors:
                                                                    colorizeColors,
  ...
  getDifference(index) {
    ...
    if (temp.day == DateTime.now().day) {
      ...
      return int.tryParse(cancelTime) != null
          ? int.parse(cancelTime) > temp.difference(DateTime.now()).inHours
          : false;
    } else {
      print(false);
      return false;
                    ...
                    child: Column(
                      children: [
                        AnimatedTextKit(
                          animatedTexts: [
                            ColorizeAnimatedText(
                              "Cancellation Charge ₹${rideList[index].cancelCharge} will be deducted from the wallet.",
