class MyRideModel {
  ...
  MyRideModel.fromJson(Map<String, dynamic> json) {
    ...
    stateTaxCharge = json['state_tax_charge'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['pollution_expiry'] = this.pollutionExpiry;
    data['vehicle_no'] = this.vehicleNo;
    data['luggage_carrier'] = this.luggageCarrier;
    ...
    data['final_total'] = this.finalAmount;
    data['final_distance'] = this.finalDistance;
    ...
    data['state_tax_charge'] = this.stateTaxCharge;
